...
def rpyeq (roll, pitch, yaw, r, p, y):
    return feq(roll,r) and feq(pitch,p) and feq(yaw,y)




def bot_quat_mult(a, b):
    """
    bot_quat_mult:
...
def bot_quat_rotate_and_translate (rot, t, v):
    ab  =  rot[0]*rot[1]
    ac = rot[0]*rot[2]
    ad  =  rot[0]*rot[3]
    nbb = -rot[1]*rot[1]
